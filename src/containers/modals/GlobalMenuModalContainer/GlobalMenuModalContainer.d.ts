import DefaultMobile from './GlobalMenuModalContainer.mobile';
import * as mobile from './GlobalMenuModalContainer.mobile';
...
export * from './GlobalMenuModalContainer.mobile';
